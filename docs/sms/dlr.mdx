...
async function getDeliveryMetrics(dateFrom, dateTo) {
  const response = await axios.get('https://api.sendexa.co/v1/sms/history', {
...
- 🔔 **[Set Up Webhooks](/docs/sms/webhooks)** - Real-time delivery notifications
- 🔄 **[Resend Failed Messages](/docs/sms/v1#resend)** - Retry logic
- 📊 **[View Analytics](/dashboard/analytics)** - Detailed metrics
- 💬 **[Get Support](/support)** - Need help?
