...
// Make a call
await makeCall('233501234567', '233302123456', 'https://yourapp.com/voice.xml');
...
- 📢 **[Broadcast Calls](/docs/voice/broadcast)** - Send to multiple recipients
- 🗣️ **[Text-to-Speech](/docs/voice/tts)** - Generate speech
- 🎛️ **[Build IVR](/docs/voice/ivr)** - Interactive voice menus
- 🔔 **[Set Up Webhooks](/docs/voice/webhooks)** - Real-time events
