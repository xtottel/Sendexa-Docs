...
- ✅ `ALERT`
- ❌ `AB` (too short)
- ❌ `MyBrand-Shop` (contains dash)
- ❌ `VeryLongBrandName` (too long)
...
const templates = {
  ...
  order: (orderId) => `Order #${orderId} confirmed. Track: https://shop.com/t/${orderId}`
};
...
- 📊 **[Track Delivery Reports](/docs/sms/dlr)** - Monitor message status
- 🔔 **[Set Up Webhooks](/docs/sms/webhooks)** - Receive real-time updates
- 🛠️ **[API Reference](/docs/sms/v1)** - Complete endpoint documentation
- 💡 **[View Examples](https://github.com/sendexa/examples)** - Code samples