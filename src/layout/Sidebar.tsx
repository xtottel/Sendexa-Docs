...
const sectionIcons = {
  ...
  "Getting Started": Zap,
  "SendExa UIs": SquareDashedMousePointer,
  Playground: BugPlay,
  "SMS API": MessageSquareText,
  "Verify API (OTP)": LockKeyhole,
  "Email API": MailCheck,
  "Voice API": PhoneCall,
  "WhatsApp API": FaWhatsapp,
  "Push API": MessageSquareText,
  "Developer Tools": ToolCase,
    ...
    >
      ...
      <div className="relative z-10 flex h-full flex-col">
        <SidebarHeader className="border-b border-border/40 bg-gradient-to-r from-primary/5 via-primary/3 to-transparent">
          <SidebarMenu>
            <SidebarMenuItem>
              ...
              >
                <Link href="/docs" className="relative overflow-hidden">
                  {/* <Image
                    src="/exaweb.png"
                    alt="Sendexa Logo"
                    width={50}
                  ...
                  />
                  <span className="ml-3 text-lg font-semibold text-foreground group-hover:text-primary transition-colors duration-300">
                    Docs
                  </span>
        ...
        <div className="mt-auto p-4 border-t border-white/10 bg-gradient-to-r from-white/5 via-white/3 to-transparent">
          <div
            onClick={() => router.push("https://sendexa.co/contact")}
