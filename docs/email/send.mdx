...
- 📝 **[Templates](/docs/email/templates)** - Create reusable templates
- 📎 **[Attachments](/docs/email/attachments)** - Send files
- 🔔 **[Webhooks](/docs/email/webhooks)** - Real-time notifications
