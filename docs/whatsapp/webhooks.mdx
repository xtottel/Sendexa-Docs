    ...
    if (message.includes('help')) {
      ...
      await sendWhatsApp(event.from, {
        ...
        interactive: {
          ...
          action: {
            buttons: [
              { type: 'reply', reply: { id: 'check_order', title: 'Check Status' } },
...
- 📱 **[Send Messages](/docs/whatsapp/send)** - Reply to incoming messages
- 📢 **[Create Broadcasts](/docs/whatsapp/broadcasts)** - Send to multiple contacts
- 👥 **[Manage Contacts](/docs/whatsapp/contacts)** - Organize users
