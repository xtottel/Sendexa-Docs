...
```
┌─────────────┐     ┌────────────┐     ┌─────────────┐     ┌────────────┐
│   Install   │────▶│  Register  │────▶│   Active    │────▶│ Uninstall  │
│     App     │     │   Device   │     │   (sends)   │     │  (remove)  │
└─────────────┘     └────────────┘     └─────────────┘     └────────────┘
```
...
- 📊 **[View Analytics](/dashboard/push/analytics)** - Track device metrics
- 📱 **[Send Notifications](/docs/push/send)** - Start sending push
