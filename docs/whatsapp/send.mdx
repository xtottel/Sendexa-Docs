...
```javascript
// âœ… Correct - Use template for first message
await sendTemplate('233501234567', 'welcome_message');

// âŒ Wrong - Cannot send session message first
...
- 👥 **[Manage Contacts](/docs/whatsapp/contacts)** - Organize recipients
- 📝 **[Message Templates](/docs/whatsapp/templates)** - Create reusable templates
- 🔔 **[Set Up Webhooks](/docs/whatsapp/webhooks)** - Receive real-time updates
- 🛠️ **[API Reference](/docs/whatsapp/v1)** - Complete endpoint documentation